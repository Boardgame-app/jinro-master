function OpenHelpModal() {
  ...
  document.getElementById("Help").innerHTML = `
    ...
    ■役職<br>
    １日目の夜に役職確認を行い、役職をドロップダウンリストから選択してください。<br>
    末尾に「＊」のある役職は、夜に行動する能力を持つ役職です。<br>
    ゲーム開始後に役職名をクリックすると、役職の説明を見ることができます。<br><br>

    ■ゲーム開始<br>
    役職の入力が完了したら、「ゲーム開始」ボタンを押してください。<br>
    ...
    タフガイは、Flag1にチェックが入っていても死亡しませんが、Flag2にチェックが入ります（翌日に再度フラグを実行すると死亡する）。<br>
    `;
